...
const DEFAULT = { siteName: 'PagerMonitor', siteDescription: 'Real-time pager decoder', newBadgeSeconds: 10, mapDotColor: '#00ff9d', showMapButton: true, mapMaxAgeDays: 30, publicMode: false, geocodeCountry: 'si', locale: 'sl-SI', hour12: false, weatherLat: '', weatherLon: '', weatherZoom: '' };
    ...
    fetch(`${BASE}/api/site-settings`)
      ...
      .then(d => {
        ...
        const s = {
          ...
          weatherLon:      d.weatherLon  || '',
          weatherZoom:     d.weatherZoom || '',
        };
        setSettings(s);
