...
export const addTrackedAircraft       = (registration, icao24) => req('POST', '/api/aircraft/tracked', { registration, ...(icao24 ? { icao24 } : {}) });
export const setTrackedAircraftEnabled = (id, enabled) => req('PATCH', `/api/aircraft/tracked/${id}`, { enabled });
export const setTrackedAircraftIcao24  = (id, icao24)  => req('PATCH', `/api/aircraft/tracked/${id}`, { icao24 });
